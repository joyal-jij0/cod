...
export default function Header(){
    return(
        <>
            ...
            <div className="cpd top">C.P.D</div>
            ...
            <div className="third-banner">
                ...
                <a href="https://www.linkedin.com/in/anshul-santoshi-0b9b99285/"><div className="top who"> Anshul Santoshi</div></a>
            ...
            <div className="fourth-banner">
                ...
                <div className="top"><button className="sp">JOIN NOW</button></div>
            </div>
